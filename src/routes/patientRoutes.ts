...
import { getDoctors, getDoctorSlots, createHold, confirm, cancel, submitSymptoms, getAppointmentSummary, getPatientAppointments, joinWaitlist } from '../controllers/patientController';
...
router.post('/doctors/:id/waitlist', joinWaitlist);
